    ...
    function addingOrder() {
        document.querySelector('.btn1').addEventListener('click', () => {
            if (ord.typeOfDrink == 'Пиво' && ord.quantityOfDrinks > 100 || ord.typeOfDrink == 'Пиво' && parseInt(document.querySelector('.input-2').value) <
                parseInt(document.querySelector('.quantity-of-drinks').value) || ord.typeOfDrink == 'Пиво' && beerRes > 100) {
                allOrders.push();
                ...
                parseInt(document.querySelector('.quantity-of-drinks').value) || ord.typeOfDrink == 'Вино' && wineRes > 50) {
                allOrders.push();
                ...
                parseInt(document.querySelector('.quantity-of-drinks').value) || ord.typeOfDrink == 'Пепсі' && pepsiRes > 50) {
                allOrders.push();
